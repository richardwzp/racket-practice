...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname exercise_216_7_12) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(check-expect (last-scene (list (make-location 50 50 "right")))
              (place-image BOARDER-MESSAGE
                           65 75
                           (worm-render (list (make-location 50 50 "right")))))
