...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname exercise_43_5_27) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;#lang racket
(require 2htdp/image)
...
(define (render cw)
  (place-image CAR cw (+ Y_CAR (sin cw)) BACKGROUND))
; WorldState -> boolean
